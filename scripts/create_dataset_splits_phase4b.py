#!/usr/bin/env python3
"""
HDDB Dataset Split Generation (Phase 4-B)
=========================================

Create train/val/test splits for HDDB dataset, excluding sub050.
...
class DatasetSplitterPhase4B:
    ...
    def __init__(
        ...
        Args:
            ...
            excluded_subjects: List of subjects to exclude from all splits
        """
        ...
        self.logger = setup_logger("DatasetSplitterPhase4B")
    ...
    def find_complete_utterances(self) -> dict:
        ...
        if self.excluded_subjects:
            self.logger.info(f"Excluded subjects: {', '.join(self.excluded_subjects)}")
...
def main():
    ...
    # Create splitter
    splitter = DatasetSplitterPhase4B(
